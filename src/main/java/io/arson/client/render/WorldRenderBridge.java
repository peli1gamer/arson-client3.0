...
public final class WorldRenderBridge {
    ...
    public void attach(){if(registered)return;WorldRenderEvents.AFTER_ENTITIES.register(context->{frame++;if(contextAdapter!=null)contextAdapter.render(featureContext,frame,0.0f);for(WorldRenderStage stage:stages)stage.render(context);});registered=true;}
