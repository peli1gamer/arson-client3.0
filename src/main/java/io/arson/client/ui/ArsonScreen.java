...
public final class ArsonScreen extends Screen {
    ...
    private void beginStringEdit(StringSetting setting) { editingString = setting; rebuild(); }
    ...
    private void addFooter(int panelX, int panelY) {
        ...
        profileBox.setHint(Component.literal("Profile name...")); profileBox.setMaxLength(32); addRenderableWidget(profileBox);
    ...
    @Override public boolean charTyped(char codePoint, int modifiers) {
        if (bindingModule == null && ((profileBox != null && profileBox.isFocused()) || (stringBox != null && stringBox.isFocused()))) return super.charTyped(codePoint, modifiers);
    ...
    @Override public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        graphics.text(font, "Arson Client V3", panelX + 18, panelY + 18, 0xFFFFFFFF, true);
        graphics.text(font, "Modules / Settings", panelX + 18, panelY + 34, 0xFFAAAAAA, false);
        graphics.text(font, selectedCategory.displayName(), panelX + 145, panelY + 40, 0xFFFFFFFF, true);
        graphics.text(font, "Enabled: " + ArsonClient.getInstance().modules().enabledCount(), panelX + 415, panelY + 40, 0xFFAAAAAA, false);
