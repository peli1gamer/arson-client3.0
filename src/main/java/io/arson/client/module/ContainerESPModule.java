...
public final class ContainerESPModule extends VisualModule {
    ...
    public ContainerESPModule() {
        super("container-esp", "Container ESP", false);
    }
    ...
    public float outlineAlpha() { return (float) super.outlineAlpha(); }
    public float lineWidth() { return (float) super.lineWidth(); }
    ...
    private static RenderStyle style(int argb, boolean fill, boolean outline, double fillAlpha, double outlineAlpha, double lineWidth) {
        ...
        int b = argb & 0xFF;
        int a = (argb >>> 24) & 0xFF;
        return new RenderStyle(new io.arson.client.render.RenderColor(r, g, b, a), fill, outline,
